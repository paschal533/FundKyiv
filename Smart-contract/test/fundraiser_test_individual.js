const FundraiserContract = artifacts.require("IndividualFundraiser");

contract("Individual Fundraiser", accounts => {
  let fundraiser;
  ...
  describe("initialization", () => {
    ...
    it("gets the limit", async () => {
      const actaul = await fundraiser.limit();
      assert.equal(actaul, limit, "owner should match");
    });
  });
